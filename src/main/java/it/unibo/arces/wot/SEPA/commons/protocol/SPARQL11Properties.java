...
public class SPARQL11Properties {
	...
	/**
	 * Gets a integer parameter from the JSON file. The following cases are supported:
	 *
	 * {"nestedKey":value}
	 * {"rootKey" : {"nestedKey : value"}}
	 * {"rootKey" : {} , "nestedKey" : value}
	 * 
	 * @param rootKey
	 *            the root key
	 ...
	 *            the nested key
	 * @param def
	 *            the default to be returned if none of the previous cases is matched
	...
	/**
	 * Gets a string parameter from the JSON file. The following cases are supported:
	 * 
	 * {"nestedKey":value}
	 * {"rootKey" : {"nestedKey : value"}}
	 * {"rootKey" : {} , "nestedKey" : value}
